# -*- coding: utf-8 -*-
"""
Created on Tue Apr 24 19:29:21 2018
...
#print(authorIndex1+1," and ",authorIndex2+1," have ",len(intersection(top_features1,top_features2))," words in common.")
d.iloc[authorIndex1,authorIndex2]=len(intersection(top_features1,top_features2))
print(len(intersection(top_features1,top_features2)),",",end='')
